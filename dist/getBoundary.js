...
function getBoundary() {
  ...
  var _iterator = _createForOfIteratorHelper(contentTypeParts),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var contentTypePart = _step.value;

      var _trim$split = (contentTypePart || '').trim().split('='),
          _trim$split2 = _slicedToArray(_trim$split, 2),
          key = _trim$split2[0],
          value = _trim$split2[1];
